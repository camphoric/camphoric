 ...
 * row per leaf unit; each assigned camper is a bar spanning their stay, offset
 * by half a day (campers arrive midday of their first day and depart midday of
 * the day after their last). Unassigned campers sit in a sidebar and are dragged
 * into a leaf×day
      ...
      <Group align="flex-start" wrap="nowrap" gap="md">
        ...
        <Stack gap="sm" style={{ flex: 1, minWidth: 0 }}>
          ...
          <ScrollArea type="auto">
            <Box style={{ minWidth: LABEL_WIDTH + days.length * DAY_WIDTH + DAY_WIDTH / 2 }}>
              {/* Header: day columns. */}
    ...
    <Group gap={0} wrap="nowrap" style={{ borderTop: '1px solid var(--mantine-color-default-border)' }}>
      ...
      <Box
        style={{
          position: 'relative',
          height: rowHeight,
          // Extra half-day so a stay ending on the last event day (which departs
          // mid-day the following day) isn't clipped.
          width: days.length * DAY_WIDTH + DAY_WIDTH / 2,
        }}
      >
  ...
  return (
    <Box
      ...
      style={{
        ...
        left: (span.start + 0.5) * DAY_WIDTH + 2,
