...
- **[CONTAINER.md](./CONTAINER.md)** — the container image: environment variables, mount points,
  and how to run it.
...
Each release also publishes a container image to `ghcr.io/camphoric/camphoric` — see
